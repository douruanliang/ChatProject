...
public class Foo {
    ...
    public static final String COMMAMD_DIR = "00bye00";
    public static final String COMMAMD_GROUP_JOIN = "--m g join";
    public static final String COMMAMD_GROUP_LEAVE = "--m g leaveø";
    public static final String COMMAMD_GROUP_NAMW = "ANDROID";
